...
describe("FormInput", () => {
    describe("when label prop is provided", () => {
        it("renders an input linked to its label via getByLabelText", () => {
            render(_jsx(FormInput, { label: "Username", name: "username" }));
    ...
    describe("when label prop is omitted", () => {
        it("renders no label", () => {
            const { container } = render(_jsx(FormInput, { name: "username" }));
    ...
    describe("when errors prop is provided", () => {
        it("renders error messages", () => {
            ...
            render(_jsx(FormInput, { label: "Username", name: "username", errors: errors }));
