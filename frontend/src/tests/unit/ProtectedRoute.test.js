...
const renderProtectedRoute = (authOverrides = {}) => {
    render(_jsx(MemoryRouter, { children: _jsx(AuthContext.Provider, { value: Object.assign(Object.assign({}, mockAuthContext), authOverrides), children: _jsx(ProtectedRoute, { children: _jsx("div", { children: "Protected Content" }) }) }) }));
};
